...
export default function SimpleCalendar({ userId }: SimpleCalendarProps) {
                  ...
                  return (
                    <div key={activity.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                      <div className="flex items-center space-x-3">
                        <div className={`w-3 h-3 rounded-full ${getCategoryColor(activityData?.category)}`}></div>
                        <div>
                          <p className="font-medium">{activityData?.title}</p>
                          <p className="text-sm text-gray-600">
                            {time} • {activityData?.duration} min
                          </p>
                        </div>
                      </div>
